...
namespace Nanu_Alexandra_Lab2.Data
{
    public class Nanu_Alexandra_Lab2Context : DbContext
    {
        ...
        public DbSet<Nanu_Alexandra_Lab2.Models.Author> Author { get; set; } = default!;
        public DbSet<Nanu_Alexandra_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Nanu_Alexandra_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Nanu_Alexandra_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
